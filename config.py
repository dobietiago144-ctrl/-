...
DOCUMENT_NO_PATTERNS = [
    r"[A-Za-z一-鿿、]+规字" + _B + _Y + _E + r"\d+号",   # 粤自然资规字〔2024〕6号
    r"[A-Za-z一-鿿、]+发" + _B + _Y + _E + r"\d+号",     # 自然资发〔2024〕204号
    r"[A-Za-z一-鿿、]+办发" + _B + _Y + _E + r"\d+号",   # 自然资办发〔2024〕8号
    r"[A-Za-z一-鿿、]+函" + _B + _Y + _E + r"\d+号",     # 自然资函〔2024〕12号
    r"[A-Za-z一-鿿、]+" + _B + _Y + _E + r"\d+号",       # 其他带年份括号的文号
